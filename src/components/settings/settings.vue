<template>
   <div class="text-center my-4">
      <div class="text-default">{{ $t('character_edit') }}</div>
      <settings-button
         v-on:click="lock"
      ...
      <a href="https://t.me/andrejevve" class="btn btn-primary" target="_blank"> <i class="fab fa-telegram-plane fa-fw"></i></a>
      <span class="btn btn-outline col-6">
         {{ $t('contact_author') }}
      </span>
      <a href="https://twitter.com/andrejevve" class="btn btn-primary" target="_blank"> <i class="fab fa-twitter fa-fw"></i></a>
   </div>
</template>
